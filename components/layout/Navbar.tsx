    ...
    <>
      ...
      <div className="container-page h-full flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group min-w-0" aria-label="Hussaini Law Group home">
          <div className="relative h-14 w-14 md:h-16 md:w-16 shrink-0 overflow-hidden rounded-lg bg-white ring-1 ring-white/25 shadow-sm">
            <Image src="/logo.png" alt="" fill sizes="64px" className="object-contain p-0.5" priority />
          </div>
